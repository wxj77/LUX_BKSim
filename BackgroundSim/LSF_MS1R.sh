...
cd $MSLOCATION
source $MSLOCATION/EDepMacGenerator_R.sh $1 $2 $3 $MACROLOCATION $OUTPUTFOLDER $DATE
cd $LUXSIMLOCATION
...
${ROOTREADERLOCATION}/LUXRootReader $OUTPUTFOLDER/$2/$3/R4Bkg_$2_$3_$1.bin
...
#rm -f $OUTPUTFOLDER/$2/$3/R4Bkg_$2_$3_$1.root ##Wei, keep results for .root to check the correctness of simulations.
rm -f $OUTPUTFOLDER/$2/$3/R4Bkg_$2_$3_$1.bin
